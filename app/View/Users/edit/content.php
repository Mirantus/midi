...
<form name="edit" method="post" action="<?=$this->app->pageUrl;?>" class="form">
    ...
    <label for="password" class="label"> <?=$form->password->title;?>:</label>
    <input id="password" name="password" type="password" maxlength="255" class="input">
